    ...
    Omni.connection.on("omni", function(data) {
        for (var collectionName in data) {
            ...
            for (var x in collectionObj.models) {
                var model = new Omni.ModelProtos[collectionObj.modelName](collectionObj.models[x]);
            ...
            if (window.Collections[collectionName] != null) {
                ...
                window.Collections[collectionName] = new Omni.CollectionProtos[collectionObj.name](models);
            }
